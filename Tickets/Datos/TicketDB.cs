    ...
    public class TicketDB
    {
        ...
        public bool Guardar(Ticket ticket, List<DetalleTicket> detalles)
        {
            ...
            try
            {
                ...
                sqlTicket.Append(" INSERT INTO ticket (Fecha, IdentidadCliente, CodigoUsuario, DescripcionSolicitud, DescripcionRespuesta, ISV, Descuento, Total) VALUES (@Fecha, @IdentidadCliente, @CodigoUsuario, @DescripcionSolicitud, @DescripcionRespuesta, @ISV, @Descuento, @Total); ");
                sqlTicket.Append(" SELECT LAST_INSERT_ID(); ");

                StringBuilder sqlDetalle = new StringBuilder();
                sqlDetalle.Append(" INSERT INTO detalleticket (IdTicket, TipoSoporte, Precio, Total) VALUES (@IdTicket, @TipoSoporte, @Precio, @Total); ");
                ...
                using (MySqlConnection con = new MySqlConnection(cadena))
                {
                    ...
                    try
                    {
                        using (MySqlCommand cmd1 = new MySqlCommand(sqlTicket.ToString(), con, transaction))
                        {
                            ...
                            cmd1.Parameters.Add("@DescripcionSolicitud", MySqlDbType.VarChar, 200).Value = ticket.DescripcionSolicitud;
                            cmd1.Parameters.Add("@DescripcionRespuesta", MySqlDbType.VarChar, 200).Value = ticket.DescripcionRespuesta;
